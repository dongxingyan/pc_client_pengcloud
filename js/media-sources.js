...
.directive('pexTestAudio', function() {
    return {
        template: '<a href="" class="outline square button" style="border:1px solid; border-radius: 20px;" ng-click="previewAudioOutput()"><span translate>IDS_SETTINGS_AUDIO_OUTPUT_TEST</span></a>',
